...
void main() {
  ...
  // (any, any)とすると次のエラー: The argument type 'Null' can't be assigned to the parameter type 'String'.
  ...
  group('sign in', () {
    testWidgets(
      ...
      // 以下は The argument type 'Null' can't be assigned to the parameter type 'String'. とエラーが出てしまう
    ...
    testWidgets(
      ...
      // 以下は The following _CastError was thrown running a test: type 'Null' is not a subtype of type 'Finder' in type cast とエラーが出てしまう
  ...
  group('register', () {
    ...
    testWidgets(
        'WHEN taps on the secondary button'
      ...
      // 以下は The following _TypeError was thrown running a test:
